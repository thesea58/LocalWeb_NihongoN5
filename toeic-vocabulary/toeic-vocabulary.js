...
if (!hasExample) {
return `
<section class="translation-panel" aria-label="Câu ví dụ" style="min-height: 0;">
<p class="section-label">例文 · Câu ví dụ</p>
<p class="result-meaning" style="margin: 0; white-space: normal;">Chưa có câu ví dụ cho từ này.</p>
</section>
`;
}
return `
<section class="translation-panel" aria-labelledby="exampleTitle" style="min-height: 0;">
<p id="exampleTitle" class="section-label">例文 · Example sentences · Câu ví dụ</p>
<div style="display: grid; gap: 16px;">
<div>
<div class="japanese-row" style="justify-content: flex-start;">
<p class="section-label" style="margin: 0;">日本語</p>
${examples.japanese ? `
<button
class="speak-button"
type="button"
...
<p class="japanese-text" style="margin-top: 8px; font-size: clamp(1.2rem, 2.5vw, 1.65rem);">
${escapeHtml(examples.japanese || "—")}
</p>
</div>
<div>
<div class="english-row" style="justify-content: flex-start;">
<p class="section-label" style="margin: 0;">English</p>
${examples.english ? `
<button
class="speak-button"
type="button"
...
<p style="margin: 8px 0 0; font-size: 1.08rem; line-height: 1.65; font-weight: 650;">
${escapeHtml(examples.english || "—")}
</p>
</div>
<div>
<p class="section-label">Tiếng Việt</p>
<p style="margin: 0; color: var(--muted); font-size: 1rem; line-height: 1.65;">
${escapeHtml(examples.vietnamese || "—")}
</p>
</div>
</div>
</section>
...
<section class="english-block" aria-labelledby="japaneseWord">
<p class="section-label">日本語 · Japanese</p>
<div class="japanese-row">
<h2
id="japaneseWord"
class="japanese-text"
style="font-size: clamp(2.8rem, 8vw, 5.5rem); line-height: 1.15; overflow-wrap: anywhere;"
>${escapeHtml(word.japanese)}</h2>
<button
class="speak-button"
type="button"
data-speak="japanese"
...
id="englishWord"
class="english-word"
style="font-size: clamp(2rem, 5vw, 3.7rem);"
>${escapeHtml(word.english)}</h3>
<button
class="speak-button"
type="button"
data-speak="english"
